<template>
  ...
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    ...
    <vs-dropdown-menu class="notification-dropdown dropdown-custom vx-navbar-dropdown" style="width:380px">
      ...
      unreadNotifications: [
          {
            ...
            msg      : 'Организуете CIP сервис в аэропорту Нью-Йорка?',
            icon     : 'MessageSquareIcon',
            time     : this.randomDate({sec: 10}),
            category : 'primary'
          },
          { index    : 1,
            title    : 'Новая заявка #532458',
            msg      : 'Греция, Афины (ФОП Васюченко В.А.)',
            icon     : 'PackageIcon',
          ...
          { index    : 2,
            ...
            msg      : 'Не погашена задолженость перед "HotelsPro" - 530,4',
          ...
          { index    : 4,
            ...
            msg      : 'Конференция "Реклама тур. продуктов в чатботах"',
            icon     : 'CalendarIcon',
